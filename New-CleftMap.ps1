...
param(
    ...
    [string]$Folder   = 'Cleftwater',
    [string]$MapName  = 'Cleftwater',
...
[MapGen]::BuildMesaField($Seed, 13.0, 8.0)

Write-Host "Building heightfield ($Size m, meandering river + pathed mesas)..."
[MapGen]::BuildHeight()
