...
if (-not ('MapGen' -as [type])) {
    $sources = 'MapGen.cs', 'PathedMesas.cs', 'Generator.cs', 'Resources.cs', 'Terrain.cs', 'ScMap.cs', 'ScMapEnvironment.cs', 'ScWrecks.cs', 'ScMapProps.cs', 'ScMapTextures.cs', 'ScMapPropScan.cs', 'ScPropImport.cs', 'ScMapDecalScan.cs', 'ScMapSplat.cs', 'Bc7.cs', 'Dxt.cs', 'DdsMean.cs', 'DdsWrite.cs', 'Bc3.cs', 'DdsDecode.cs'
